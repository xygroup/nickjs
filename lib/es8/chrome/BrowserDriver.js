...
// 			"--disable-extensions",
    ...
    if (typeof this._options.userDataDirectory === 'string') {
      console.log(`Setting --user-data-dir=${this._options.userDataDirectory}`)
      childOptions.push(`--user-data-dir=${this._options.userDataDirectory}`)
    }
